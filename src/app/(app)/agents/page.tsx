    ...
    <div className="mx-auto w-full max-w-6xl px-6 py-10 md:px-10 md:py-14">
      ...
      {recent.length > 0 && (
        <div className="mt-12">
          ...
          <ul className="mt-4 flex flex-col divide-y divide-[--color-border]/60 rounded-xl border border-[--color-border] bg-[--color-card]">
            {recent.map((r) => {
              ...
              return (
                <li key={r.id}>
                  <Link
                    ...
                    className="grid grid-cols-[auto,1fr,auto,auto,auto] items-center gap-4 px-4 py-3 text-sm transition hover:bg-[--color-muted]/30"
                  >
